...
def convert_markdown_to_html(markdown_file_path: str, output_html_path: str):
    """
...
<head>
    ...
    <title>{os.path.basename(markdown_file_path).replace('.md', '')}</title>
    <style>
...
def main():
    parser = argparse.ArgumentParser(
        description="Converte um arquivo Markdown para HTML com suporte a tabelas, LaTeX e destaque de sintaxe."
    )
    parser.add_argument(
        "markdown_file",
        help="Caminho para o arquivo Markdown de entrada (.md)"
    )
    parser.add_argument(
        "output_html",
        help="Caminho para o arquivo HTML de saída (.html)"
    )
    ...
    convert_markdown_to_html(args.markdown_file, args.output_html)
